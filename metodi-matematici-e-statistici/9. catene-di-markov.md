...
La **legge** mi dice qualè la probabilità, ad ogni istante di tempo, di trovarmi in un dato stato.

Se $X_0$ è lo stato all'istante iniziale e $v$ è la sua legge
...
$w$ si dice legge al passo $n$, ovvero $w = (w_1, \dots,w_n)$ e $w_k = P(X_n = k)$. 
...
Una legge o distribuzione $v$ è stazionaria se non evolve più, ovvero se vale 

$$
v = vP^{(n)} \Rightarrow v = vP
$$
